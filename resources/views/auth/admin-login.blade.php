        ...
        <div class="hidden lg:flex w-[45%] flex-col justify-center items-center text-center p-12 relative overflow-hidden">
            <div class="relative z-10 animate-fade-in-up">
                <h1 class="text-white text-4xl font-extrabold mb-6 drop-shadow-lg leading-tight">
                    Portal Admin<br>Sistem Magang
                </h1>
                <p class="text-teal-50 text-lg mb-10 opacity-90">Kelola sistem informasi magang secara efisien <br> Universitas Tiga Serangkai</p>
                
                <div class="w-full flex justify-center animate-float">
                    <img src="/images/ic_logreg.svg" class="w-80 h-auto drop-shadow-2xl" alt="Ilustrasi Login Admin">
                </div>
            </div>
        ...
        <div class="w-full lg:w-[55%] bg-white h-full rounded-l-[40px] lg:rounded-l-[80px] flex flex-col justify-center px-8 sm:px-12 md:px-20 lg:px-24 py-8 overflow-y-auto shadow-2xl relative z-20 no-scrollbar">
            ...
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="mb-10 animate-fade-in-up delay-200 opacity-0" style="animation-fill-mode: forwards;">
                    <h2 class="text-3xl font-bold text-gray-900 mb-3">Selamat Datang Admin!</h2>
                    <p class="text-gray-500">Gunakan kredensial admin Anda untuk mengakses sistem.</p>
                </div>

                <form id="form-login-admin" x-data="{ show: false, password: '' }" action="{{ route('login') }}" method="POST" class="space-y-6 animate-fade-in-up delay-300 opacity-0" style="animation-fill-mode: forwards;">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="email" id="email" name="email" placeholder="contoh: admin@tsu.ac.id" required
                    ...
                    <p class="text-center text-sm text-gray-500 mt-8 animate-fade-in-up delay-400 opacity-0" style="animation-fill-mode: forwards;">
                        Bukan Admin? <a href="{{ route('login') }}" class="text-tsu-teal font-bold hover:underline transition-all">Masuk Sebagai Mahasiswa</a>
                    </p>
                </form>
            </div>
                ...
                loginForm.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        if (response.ok && data.success) {
                            ...
                            // Validasi Error (email / password salah atau salah pintu loggin)
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: 'Gagal terhubung ke server atau terjadi kesalahan internal.',
                            confirmButtonColor: '#086375'
                        });
                        submitBtn.innerText = originalBtnText;
                        submitBtn.disabled = false;
