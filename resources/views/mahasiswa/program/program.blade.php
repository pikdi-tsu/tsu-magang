...
@php
    $jobs = $programs->map(function ($program) {
        ...
        return [
            ...
            'prodi' => is_array($program->prodi) ? $program->prodi : [],
        ];
    });
@endphp
...
<div x-data="{
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-9 gap-3 mb-10">
        <template x-for="(cat, index) in categories" :key="cat.id">
            <button @click="tab = cat.id; page = 1"
                ...
                :class="tab === cat.id
                    ? 'bg-tsu-teal border-tsu-teal text-white shadow-teal-100'
                    : 'bg-white border-gray-100 text-gray-600 hover:border-tsu-teal hover:bg-teal-50'">
    ...
    <div id="lowongan-section" class="fade-up border border-gray-200 bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-sm min-h-[500px]">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-8 border-b border-gray-100 pb-6">
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Menampilkan program magang terbaru</p>
            </div>
        </div>
                    ...
                    <div>
                        ...
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <div class="flex gap-1 flex-wrap justify-end">
                                <template x-for="p in job.prodi" :key="p">
        ...
        {{-- Empty State --}}
        <div x-show="filteredJobs.length === 0" class="flex flex-col items-center justify-center py-20 text-center">
        ...
        {{-- Pagination --}}
        <div class="flex items-center justify-center gap-2 mt-12" x-show="filteredJobs.length > 0 && totalPages > 1">
    ...
    <div class="fade-up delay-[500ms] border border-gray-300 rounded-xl p-6 mb-8 text-center bg-white shadow-sm">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div class="text-center p-6 rounded-2xl bg-red-50/50 border border-red-100">
            ...
            <div class="text-center p-6 rounded-2xl bg-green-50/50 border border-green-100">
            ...
            <div class="text-center p-6 rounded-2xl bg-blue-50/50 border border-blue-100">
